...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ADMIN\Django_Dev_Laude\FirstDjango_Laude'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ADMIN\Django_Dev_Laude\FirstDjango_Laude\Scripts\deactivate.nu'
